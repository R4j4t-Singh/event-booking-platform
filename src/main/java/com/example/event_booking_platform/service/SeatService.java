...
public class SeatService {
    ...
    public List<Seat> getSeats(Long showId) throws EventNotFoundException {
        Show show = showRepository.findById(showId).orElseThrow(() -> new EventNotFoundException("change it"));
